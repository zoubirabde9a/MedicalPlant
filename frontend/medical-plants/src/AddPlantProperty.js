...
const AddPlantProperty = (props) => {

    const {showModal, setShowModal, property} = props;
    ...
    const handleSubmit = async (e) => {
        ...
        // Add the plant
        {
            ...
            const url = `http://localhost:5202/api/${property}/Add?${queryParams.toString()}`;
            try {
...
export default AddPlantProperty;