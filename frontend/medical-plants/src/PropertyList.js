...
const PropertyList = ({filter, filterText}) => {
    ...
    useEffect(() => {
        var path = 'http://localhost:5202/api/PlantDivision/GetAllByLatinName?offset=0&limit=20&latinNameLike=' + filterText;
        if (filterText) {
            switch (filter) {
                case 'PlantOrigin':
                    path = 'http://localhost:5202/api/PlantOrigin/GetAllByLatinName?offset=0&limit=20&latinNameLike=' + filterText;
                    break;
                case 'VegetableReign':
                    path = 'http://localhost:5202/api/VegetableReign/GetAllByLatinName?offset=0&limit=20&latinNameLike=' + filterText;
                    break;
                case 'PlantDivision':
                    path = 'http://localhost:5202/api/PlantDivision/GetAllByLatinName?offset=0&limit=20&latinNameLike=' + filterText;
                    break;
                case 'PlantClass':
                    path = 'http://localhost:5202/api/PlantClass/GetAllByLatinName?offset=0&limit=20&latinNameLike=' + filterText;
                    break;
                case 'PlantFamily':
                    path = 'http://localhost:5202/api/PlantFamily/GetAllByLatinName?offset=0&limit=20&latinNameLike=' + filterText;
                    break;
                case 'PlantGenre':
                    path = 'http://localhost:5202/api/PlantGenre/GetAllByLatinName?offset=0&limit=20&latinNameLike=' + filterText;
                    break;
                case 'PlantSpecies':
                    path = 'http://localhost:5202/api/PlantSpecies/GetAllByLatinName?offset=0&limit=20&latinNameLike=' + filterText;
                    break;
                case 'PlantPart':
                    path = 'http://localhost:5202/api/PlantPart/GetAllByLatinName?offset=0&limit=20&latinNameLike=' + filterText;
                    break;
            }
        }
        fetch(path)
